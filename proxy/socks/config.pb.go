...
type ServerConfig struct {
	...
	AuthType   AuthType          `protobuf:"varint,1,opt,name=auth_type,json=authType,proto3,enum=proxy.socks.AuthType" json:"auth_type,omitempty"`
...
var file_proxy_socks_config_proto_rawDesc = []byte{
	...
	0x6e, 0x66, 0x69, 0x67, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0b, 0x70, 0x72, 0x6f, 0x78,
	...
	0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x22, 0xb6, 0x02, 0x0a, 0x0c, 0x53, 0x65, 0x72, 0x76,
	0x65, 0x72, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x32, 0x0a, 0x09, 0x61, 0x75, 0x74, 0x68,
	...
	0x70, 0x65, 0x52, 0x08, 0x61, 0x75, 0x74, 0x68, 0x54, 0x79, 0x70, 0x65, 0x12, 0x43, 0x0a, 0x08,
	0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x27,
	...
	0x73, 0x12, 0x30, 0x0a, 0x07, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x18, 0x03, 0x20, 0x01,
	0x28, 0x0b, 0x32, 0x16, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x6e, 0x65, 0x74, 0x2e,
	...
	0x62, 0x6c, 0x65, 0x64, 0x12, 0x1d, 0x0a, 0x0a, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x6c, 0x65, 0x76,
	0x65, 0x6c, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x09, 0x75, 0x73, 0x65, 0x72, 0x4c, 0x65,
	0x76, 0x65, 0x6c, 0x1a, 0x3b, 0x0a, 0x0d, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x73, 0x45,
	...
	0x74, 0x52, 0x06, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2a, 0x25, 0x0a, 0x08, 0x41, 0x75, 0x74,
	...
	0x78, 0x79, 0x2e, 0x73, 0x6f, 0x63, 0x6b, 0x73, 0x50, 0x01, 0x5a, 0x25, 0x67, 0x69, 0x74, 0x68,
...
var file_proxy_socks_config_proto_goTypes = []interface{}{
	(AuthType)(0),                   // 0: proxy.socks.AuthType
	(*Account)(nil),                 // 1: proxy.socks.Account
	(*ServerConfig)(nil),            // 2: proxy.socks.ServerConfig
	(*ClientConfig)(nil),            // 3: proxy.socks.ClientConfig
	nil,                             // 4: proxy.socks.ServerConfig.AccountsEntry
	(*net.IPOrDomain)(nil),          // 5: common.net.IPOrDomain
	(*protocol.ServerEndpoint)(nil), // 6: common.protocol.ServerEndpoint
}
var file_proxy_socks_config_proto_depIdxs = []int32{
	0, // 0: proxy.socks.ServerConfig.auth_type:type_name -> proxy.socks.AuthType
	4, // 1: proxy.socks.ServerConfig.accounts:type_name -> proxy.socks.ServerConfig.AccountsEntry
	5, // 2: proxy.socks.ServerConfig.address:type_name -> common.net.IPOrDomain
	6, // 3: proxy.socks.ClientConfig.server:type_name -> common.protocol.ServerEndpoint
