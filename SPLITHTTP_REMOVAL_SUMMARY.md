...
- 移除了 `_ "github.com/xtls/xray-core/transport/internet/splithttp"` 导入

#### `infra/conf/transport_internet.go`
- 移除了 `"github.com/xtls/xray-core/transport/internet/splithttp"` 导入
...
- 移除了 `"github.com/xtls/xray-core/common/net"` 导入
