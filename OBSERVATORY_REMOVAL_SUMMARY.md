...
- 移除了 `_ "github.com/asimov1234/newv/app/observatory/command"` 导入
- 移除了 `_ "github.com/asimov1234/newv/app/observatory"` 导入
...
- 移除了 `"github.com/asimov1234/newv/app/observatory/burst"` 导入
